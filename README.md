...
![Status]([https://img.shields.io/badge/status-active-success?style=flat-square](https://img.shields.io/badge/status-not%20being%20developed-red))
...
- 👉 **Скачать тут:** https://github.com/Nezeryxs/ScumChecker/releases/latest (Низ страницы)
...
<table>
  <tr>
    <td><img width="420" alt="Main Scan" src="assets/mainmenu.png"></td>
